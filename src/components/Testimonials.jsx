...
const Testimonials = () => {
  return (
    <div className='container mx-auto py-10 lg:px-32 w-full overflow-hidden' id='Services'>
        ...
        {testimonialsData.map((testimonial, index)=>(
            <div key={index} className='max-w-85 border-0 shadow-lg rounded px-8 py-12 text-center'>
